...
const VENDOR_BUILD = "2026-06-28-pages-real-vendor-path";
const VENDOR_BASE_PATH = "vendor/meth-super-mario";
const DAMAGE_SOUND_SRC = "vendor/meth-super-mario/audio/music/die.ogg";
const VICTORY_SOUND_SRC = "vendor/meth-super-mario/audio/music/level-clear.ogg";
const VICTORY_FALLBACK_SOUND_SRC = "vendor/meth-super-mario/audio/music/princess.ogg";
const STAGE_ONE_MUSIC_SRC = "vendor/meth-super-mario/audio/music/overworld.ogg";
const STAGE_TWO_MUSIC_SRC = "vendor/meth-super-mario/audio/music/castle.ogg";
const STAGE_TWO_FALLBACK_MUSIC_SRC = "vendor/meth-super-mario/audio/music/overworld.ogg";
