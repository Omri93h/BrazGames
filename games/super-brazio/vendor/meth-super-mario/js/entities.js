...
import {loadIceAgent1, loadIceAgent2} from './entities/IceAgent.js';
import {loadAdolfJackson} from './entities/AdolfJackson.js';
...
export async function loadEntities(audioContext) {
    ...
    await Promise.all([
        ...
        setup(loadIceAgent1)
            .then(addAs('ice-agent-1')),
        setup(loadIceAgent2)
            .then(addAs('ice-agent-2')),
        setup(loadAdolfJackson)
            .then(addAs('adolf-jackson')),
